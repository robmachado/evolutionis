...
@section('content')
    <div class="container">
        ...
        <div class="col-sm-offset-3 col-sm-6">
            <h3>Editar Tarefa de Projeto</h3>
        </div>
        <div class="col-sm-offset-3 col-sm-6">
        ...
        <form action="{{ route('tarefa.update', $model->id) }}" method="POST" class="form-horizontal">
            @csrf
            ...
            <div class="form-group {{ $errors->has('detalhe') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-12">
                <textarea name="detalhe" id="detalhe" rows="5" cols="250" class="form-control {{ $errors->has('detalhe') ? "form-error" : "" }}">{{ $model->detalhe ?? old('detalhe') }}</textarea>
            ...
            <div class="form-group {{ $errors->has('responsavel') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-12">
                <input type="text" name="responsavel" id="responsavel" class="form-control {{ $errors->has('responsavel') ? "form-error" : "" }}" value="{{ $model->responsavel ?? old('responsavel') }}">
