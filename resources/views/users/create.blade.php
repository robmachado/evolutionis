    ...
    <div class="container">
        ...
        <form action="{{ route('user.store') }}" method="POST" class="form-horizontal">
            ...
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-6">
                <input type="text" name="email" id="email" class="form-control {{ $errors->has('email') ? "form-error" : "" }}" value="{{ old('email') }}" required autocomplete="email">
                    @if($errors->has('email'))
            ...
            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-6">
                <input type="password" name="password" id="password" class="form-control {{ $errors->has('password') ? "form-error" : "" }}" value="" required autocomplete="new-password">
            ...
            <div class="form-group {{ $errors->has('passwordconfirm') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-6">
                <input type="password" name="passwordconfirm" id="passwordconfirm" class="form-control {{ $errors->has('passwordconfirm') ? "form-error" : "" }}" value="" required autocomplete="new-password">
